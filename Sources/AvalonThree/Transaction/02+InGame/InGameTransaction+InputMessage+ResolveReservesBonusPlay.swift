...
extension InGameTransaction {
    ...
    mutating func useReservesBonusPlayReservesAction(playerID: PlayerID) throws -> AddressedPrompt? {
    ...
    mutating func declineReservesBonusPlayReservesAction() throws -> AddressedPrompt? {
